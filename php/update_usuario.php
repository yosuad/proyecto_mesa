...
$sql = "UPDATE usuarios SET medio='$medio', nombre='$nombre', apellido='$apellido', tipo='$tipo', documento='$documento', correo='$correo', direccion='$direccion' WHERE id = '$id'";
...
if (!$resultado) {
    ...
    <script>
        Swal.fire({
            title: "<?php echo $nombre . ' ' . $apellido; ?> se actualizó con éxito",
            icon: "success"
        }).then(function() {
