...
?>
    ...
    <div class="update__info">
        ...
        <form action="../php/update_reserva.php" method="POST" onsubmit="return validarFormulario();">
            <table class="update__contet">
                ...
                <tr class="id__positiongrid"> 
                    <td class="">id</td>                       
                    <td class=""><input type="text" name="id" id="medio" class="nuevo__id" placeholder="id" value="<?php echo $id_registro; ?>"></td>
                </tr>

                    <tr class="medio__positiongrid"> 
                        <td class="title-nueva__reserva">Fecha</td>                       
                        <td><input type="date" name="fecha" class="input__nuevareserva" placeholder="Fecha" value="<?php echo $fecha; ?>"></td>
                    </tr>
                    <tr class="nombre__positiongrid">
                         <td class="title-nueva__reserva">Hora de inicio</td>                       
                        <td><input type="time" name="hora_inicio" class="input__nuevareserva" value="<?php echo $hora_inicio; ?>"></td>
                    </tr>
                    <tr class="apellido__positiongrid">
                        <td class="title-update__apellido">Hora de finalizar</td>
                        <td><input type="time" name="hora_fin" class="input__nuevareserva" placeholder="Hora de finalizar" value="<?php echo $hora_fin; ?>"></td>
                    </tr>
                    <tr class="tipo__positiongrid">
                        <td class="title-update__tipo">observacion</td>
                        <td><input type="text" name="observaciones" id="tipo" class="update__iput" placeholder="Tipo de Documento" value="<?php echo $observaciones; ?>"></td>
                    </tr>
                ...
                <tr class="documento__positiongrid">    
                    <td class="estado__nuevareserva">Estado</td>
                        <td>
                            <select name="estado" id="documento" class="estado__nuevareserva" value="<?php echo $estado; ?>">
                    ...
                    <tr class="btncalcelar__reserva">
                        <td><a class="cancelar__update" href="reserva.php">Cancelar</a></td>
                    </tr>
